...
if __name__ == "__main__":
    ...
    for run in range(args.num_runs):
        ...
        os.makedirs(os.path.join(args.save_root, f"logs/{args.model_name}/{args.data_name}/{args.save_model_name}/"), exist_ok=True)
        # create file handler that logs debug and higher level messages
        fh = logging.FileHandler(os.path.join(args.save_root,f"logs/{args.model_name}/{args.data_name}/{args.save_model_name}/{str(time.time())}.log"))
        ...
        save_model_folder = os.path.join(args.save_root, f"saved_models/{args.model_name}/{args.data_name}/{args.save_model_name}/")
        ...
        for epoch in range(args.num_epochs):
            ...
            if (epoch + 1) % args.test_interval_epochs == 0:
                ...
                early_stop = early_stopping.step(val_metric_indicator, 
                                                model,
                                                args)
