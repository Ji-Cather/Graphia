...
def merge_graph_matrices(root_dir="Graphia/reports", 
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="合并 Graphia 报告目录下的所有 graph_matrix.csv 文件")
    parser.add_argument("--root", type=str, default="Graphia/reports", help="根目录路径，默认: Graphia/reports")
    parser.add_argument("--output_root", type=str, default="Graphia/reports/concat", help="输出文件名，默认: merged_graph_matrix.csv")
