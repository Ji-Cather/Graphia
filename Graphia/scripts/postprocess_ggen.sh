...
export dx_src_root=Graphia/saved_results_deg/InformerDecoder_seed0_bwr1980_qmTrue_ufbert_cmTrue/${data_name}
...
#     do
#         export mode=${mode}
#         bash Graphia/scripts/postprocess_ggen_loop.sh >> query_${data_name}.log
#     done
# done
