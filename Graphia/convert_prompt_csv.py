...
def filter_and_overwrite_difficulty_1(
    source_path="Graphia/prompts/8days_dytag_small_text_en/teacher_forcing/train_query_examples.jsonl",
    target_path="Graphia/prompts/8days_dytag_small_text_en/teacher_forcing/test_ctdg.jsonl"
):
    import os
    import json
