...
def process_edge_matrix_data(file_path="Graphia/reports/concat/merged_edge_matrix.csv"):
    """
    ...
    # 重命名模型
    # 对于符合grpo*sotopia*格式的，重命名为Graphia-seq
    # 对于符合grpo*但不符合grpo*sotopia*的，重命名为Graphia
