...
def process_combined_for_latex(
    dst_input_file_path="Graphia/reports/tdgg_social_fidelity_scores.csv",
    edge_input_file_path="Graphia/reports/concat/merged_edge_matrix.csv",
    combined_output_path="Graphia/reports/latex_combined_table.tex"
):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=str,
                        default="Graphia/reports/latex_combined_table.tex",
                        help="合并表格输出路径")
