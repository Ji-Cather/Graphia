...
def plot_idgg_radar(scores_file_path="Graphia/reports/idgg_social_fidelity_scores.csv",
...
def plot_idgg_radar_comparison(scores_file_path="Graphia/reports/idgg_social_fidelity_scores.csv",
                              output_dir="Graphia/reports/figures/",
                              figsize=(15, 12)):
    """
    绘制所有数据集的综合雷达图对比
...
def plot_score_distributions(scores_file_path="Graphia/reports/idgg_social_fidelity_scores.csv",
                            output_dir="Graphia/reports/figures/"):
    """
    绘制各维度评分的分布图
...
def plot_formatted_overall_radar(scores_file_path="Graphia/reports/idgg_social_fidelity_scores.csv",
                                output_dir="Graphia/reports/figures/",
                                figsize=(10, 8)):
    """
...
def plot_formatted_dataset_radar_combined(scores_file_path="Graphia/reports/idgg_social_fidelity_scores.csv",
                                        output_dir="Graphia/reports/figures/",
                                        figsize=(20, 15)):
    """
...
def main():
    ...
    parser.add_argument("--scores_file", type=str,
                        default="Graphia/reports/idgg_social_fidelity_scores.csv",
                        help="评分文件路径")
