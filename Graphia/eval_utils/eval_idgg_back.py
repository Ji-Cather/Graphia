...
def evaluate_idgg_social_fidelity(
    graph_list_file_path="Graphia/reports/concat/merged_graph_list_matrix.csv",
    graph_file_path="Graphia/reports/concat/merged_graph_matrix.csv",
    graph_macro_file_path="Graphia/reports/concat/merged_graph_macro_matrix.csv",
    output_file_path="Graphia/reports/idgg_social_fidelity_scores.csv",
    exclude_models=None,
    weights=None
):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--graph_list_file", type=str, 
                        default="Graphia/reports/concat/merged_graph_list_matrix.csv",
                        help="graph list 矩阵文件路径")
    parser.add_argument("--graph_file", type=str,
                        default="Graphia/reports/concat/merged_graph_matrix.csv",
                        help="graph 矩阵文件路径")
    parser.add_argument("--graph_macro_file", type=str,
                        default="Graphia/reports/concat/merged_graph_macro_matrix.csv",
