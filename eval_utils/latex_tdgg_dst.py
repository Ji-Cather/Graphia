# LLMGGen/eval_utils/latex_tdgg.py
import pandas as pd
import numpy as np
...
def process_tdgg_for_latex(
    input_file_path="LLMGGen/reports/tdgg_social_fidelity_scores.csv",
    retrieval_output_path="LLMGGen/reports/latex_retrieval_table.tex",
    retrieval_recall_output_path="LLMGGen/reports/latex_retrieval_recall_table.tex",
    edge_output_path="LLMGGen/reports/latex_edge_table.tex"
):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--retrieval_recall_output", type=str,
                        default="LLMGGen/reports/latex_retrieval_recall_table.tex",
                        help="retrieval recall表格输出路径")
    parser.add_argument("--edge_output", type=str,
                        default="LLMGGen/reports/latex_edge_table.tex",
                        help="edge表格输出路径")
