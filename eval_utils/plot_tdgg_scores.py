...
import argparse
from math import pi
def plot_tdgg_radar(scores_file_path="LLMGGen/reports/tdgg_social_fidelity_scores.csv",
...
def plot_tdgg_radar_comparison(scores_file_path="LLMGGen/reports/tdgg_social_fidelity_scores.csv",
                              output_dir="LLMGGen/reports/figures/",
                              figsize=(15, 12)):
    """
    绘制所有数据集的综合雷达图对比
...
def plot_score_distributions(scores_file_path="LLMGGen/reports/tdgg_social_fidelity_scores.csv",
                            output_dir="LLMGGen/reports/figures/"):
    """
    绘制各维度评分的分布图
...
def plot_formatted_dataset_radar(scores_file_path="LLMGGen/reports/tdgg_social_fidelity_scores.csv",
                                output_dir="LLMGGen/reports/figures/",
                                figsize=(12, 10)):
    """
    为每个数据集绘制格式化标签的雷达图
...
def plot_formatted_dataset_radar_combined(scores_file_path="LLMGGen/reports/tdgg_social_fidelity_scores.csv",
                                        output_dir="LLMGGen/reports/figures/",
                                        figsize=(20, 15)):
    """
