...
# 读取CSV文件
df = pd.read_csv('LLMGGen/reports/concat/merged_edge_matrix_cut.csv')
...
# 保存详细指标图
output_path1 = 'LLMGGen/reports/figures/model_comparison_detailed_metrics.pdf'
...
# 保存汇总对比图
output_path2 = 'LLMGGen/reports/figures/model_overall_comparison.pdf'
