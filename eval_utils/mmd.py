...
import numpy as np
import scipy.stats
import LLMGGen.eval_utils.graph_metrics as graph_metrics 
import powerlaw 
def make_histograms(
...
def evaluate_sampled_graphs(real_graphs: list[nx.Graph],sampled_graphs: list[nx.Graph]) -> dict[str, float]:
