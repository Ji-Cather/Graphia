...
def main():
    ...
    parser.add_argument("--input", type=str, default="LLMGGen/reports/idgg_social_fidelity_scores.csv", help="Path to input CSV file")
    parser.add_argument("--output", type=str, default="LLMGGen/reports/idgg_social_fidelity_scores.tex",  help="Output .tex file path")
