...
def process_imdb(DGGB_root, save_root, sample_rate:float = 1):
...
if __name__ == "__main__":
    ...
    # process_weibo_daily("data/weibo_daily/raw", "data/weibo_daily/raw")
    # process_weibo_tech("data/weibo_tech/raw", "data/weibo_tech/raw")
    process_imdb("data/imdb/raw", "data/imdb/raw",sample_rate=0.1)