...
class EarlyStopping(object):
    ...
    def save_checkpoint(self, model: nn.Module, args):
        """
        ...
        config_path = os.path.join(os.path.dirname(self.save_model_path), f"{os.path.splitext(os.path.basename(self.save_model_path))[0]}_config.json")
